...
The checked-in SSE fixtures are compact, de-identified replays. System instructions, reasoning text, identifiers, and payload content are replaced with placeholders; they contain no credentials or production data.
